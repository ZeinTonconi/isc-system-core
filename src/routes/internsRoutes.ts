...
import { getInternsByUserId, getInternsController, updateHoursController, getInternsById,getRecordInternsController, getInformationsInternController, getMyEventsInternController } from "../controllers/internController";
